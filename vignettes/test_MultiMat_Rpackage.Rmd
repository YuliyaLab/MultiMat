...
MultiMat Pipeline includes six steps, which we suggest are performed in the order
shown in the flowchart in Figure 1. Individual steps such as normalization, 
imputation or presence/absence analysis can be skipped but care must be taken 
to assure that peptides passed into Model-Based Differential Expression Analysis 
step contain a sufficient number of observations. 
...
```{r}
flowchart = imager::load.image('./MultiMatPipelineFlowChart.jpeg')
plot(flowchart, axes=FALSE)
```

**Figure 1. Flow chart of the suggested MultiMat analysis pipeline.** 
...
**Figure 2. Numbers of missing values in each of the Human samples.** 
...
**Figure 3. Eigentrends for raw and residual peptide intensities in Human samples.** 
...
**Figure 4. Eigetrends for raw and normalized peptide intensities in Human samples.** 
...
**Figure 5. Eigetrends for raw and normalized peptide intensities in Human 
...
**Figure 6. Numbers of missing values in each of the Human samples.** 
mCG treatment group has more missing values. 
...
**Figure 7. Eigentrends for raw and residual peptide intensities in mouse samples.** 
Dots at positions 1-6 correspond to the 6 samples. Top trend in the Normalized 
Data (right panel) shows a pattern representative of the differences between the 
...
**Figure 8. Eigentrends for raw and normalized peptide intensities in mouse samples with the effects of one bias trends removed.**
Dots at positions 1-6 correspond to the 6 samples. Top trend in the Normalized 
...
**Figure 9. Eigentrends for raw and normalized peptide intensities in mouse samples with the effects of two bias trends removed.**
Dots at positions 1-6 correspond to the 6 samples. Top trend in the Normalized 
...
**Figure 10. All peptides within protein Prot32 in raw, normalized, and imputed form.**  
...
**Figure 11. P-value distributions for unadjusted and adjusted p-values.** 
...
**Figure 12. Distribution of p-values and fold changes for combined multi-matrix analysis of Mouse and Human.**    
...
**Figure 13. Distribution of p-values and fold changes for differential expression analysis in Mouse.** 
...
**Figure 14. Distribution of p-values and fold changes for differential expression in the combined analysis of Human and Mouse data in CG context.**
...
**Figure 16. Distribution of p-values and fold changes for the presence/absence 
